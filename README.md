...
- <code>Quality synchronization uses Barony's common packet transport for direct connections, Steam P2P, and Crossplay. Chest states, exit counts, creature sightings, and follower data are routed by player slot. Unacknowledged state updates retry every 0.3 seconds for up to 10 seconds.</code>
